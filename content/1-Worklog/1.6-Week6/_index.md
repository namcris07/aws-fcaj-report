...
| --- | --- | --- | --- | --- |
| 2 | - **GitOps & Argo CD Research:** <br>&emsp; + Study GitOps core principles on Kubernetes via pull-based deployment. <br>&emsp; + Study Argo CD `Application` Custom Resource Definition (CRD) declarative structures to manage multi-environments. <br>&emsp; + Compare synchronization strategy differences (Manual Sync vs Automated Sync). | 20/07/2026 | 20/07/2026 | [GitOps Module](https://github.com/namcris07/aws-fcaj-learning/blob/main/Worklogs/Tu%E1%BA%A7n-06-GitOps-ArgoCD.md) |
